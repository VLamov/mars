# Generated by Django 4.1.5 on 2023-01-04 07:36
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('analyzer_id', models.ForeignKey(on_delete=django.db.models.deletion.RESTRICT, to='orders_app.device',
                                                  verbose_name='Идентификатор оборудования')),
                ('customer_id',
                 models.ForeignKey(on_delete=django.db.models.deletion.RESTRICT, to='orders_app.customer',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('device',
                 models.ForeignKey(on_delete=django.db.models.deletion.RESTRICT, to='orders_app.deviceinfield',
